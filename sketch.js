...
function createCash() {
  ...
  var cash = createSprite(Math.round(random(300, width-250),40, 10, 10));
...
function createDiamonds() {
  ...
  var diamonds = createSprite(Math.round(random(300, width-250),40, 10, 10));
...
function createJwellery() {
  if (World.frameCount % 20 == 0) {
  var jwellery = createSprite(Math.round(random(300, width-250),40, 10, 10));
...
function createSword(){
  if (World.frameCount % 10 == 0) {
  var sword = createSprite(Math.round(random(300, width-250),40, 10, 10));
